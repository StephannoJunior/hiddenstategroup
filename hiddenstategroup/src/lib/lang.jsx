...
/*
  ...
  ── G10 · WHAT IS TRANSLATED, AND WHAT IS NOT ─────────────────────────────

  The GUEST's whole path is: the request form, the pass, the demo and booking
  forms. Most of the audience for a Romanian night reads Romanian, and until
  now the site read to them as an English site about a Romanian party.

  The STAFF tools — the scanner, the door list, the console — are deliberately
  left in English, and that is a decision rather than an omission. Three
  reasons, in order of weight: the words on them are operational and must mean
  exactly one thing at 2am; the people using them are five people who already
  know the tool; and a half-translated door is worse than an untranslated one,
  because it is the half you did not translate that you find at the door.
*/
...
export const STRINGS = {
  en: {
    ...
    askForAPass: "Ask for a pass",
    theGuestList: "THE GUEST LIST",
    fullName: "Full name",
    email: "Email",
    phone: "Phone",
    howManyOfYou: "How many of you",
    justMe: "Just me",
    peopleWord: "people",
    anythingToKnow: "Anything we should know",
    charsLeft: "LEFT",
    iConfirmAge: "I confirm I am",
    orOver: "or over. ID may be requested at the door.",
    sending: "SENDING…",
    requestReceived: "REQUEST RECEIVED",
    thankYou: "Thank you.",
    onTheWaitingList: "ON THE WAITING LIST",
    inTheQueue: "IN THE QUEUE",
    showAtTheDoor: "Show this at the door.",
    addToCalendar: "ADD TO YOUR CALENDAR",
    setTimes: "SET TIMES",
    refreshesIn: "REFRESHES IN",
    bringSomeone: "BRING SOMEONE",
    sendAnInvite: "SEND AN INVITE",
    linkCopiedSend: "LINK COPIED — SEND IT TO THEM",
    idMayBeRequested: "ID MAY BE REQUESTED",
    demos: "DEMOS",
    sendUsOneThing: "Send us one thing",
    sendIt: "SEND IT",
    bookings: "BOOKINGS",
    bookAnArtist: "Book an artist",
    sendTheEnquiry: "SEND THE ENQUIRY",
    closedForNow: "CLOSED",
  },
  ro: {
    ...
    askForAPass: "Cere un acces",
    theGuestList: "LISTA DE INVITAȚI",
    fullName: "Nume complet",
    email: "Email",
    phone: "Telefon",
    howManyOfYou: "Câți sunteți",
    justMe: "Doar eu",
    peopleWord: "persoane",
    anythingToKnow: "Ceva ce ar trebui să știm",
    charsLeft: "RĂMASE",
    iConfirmAge: "Confirm că am",
    orOver: "ani sau mai mult. Actul de identitate poate fi cerut la intrare.",
    sending: "SE TRIMITE…",
    requestReceived: "CERERE PRIMITĂ",
    thankYou: "Mulțumim.",
    onTheWaitingList: "PE LISTA DE AȘTEPTARE",
    inTheQueue: "ÎN RÂND",
    showAtTheDoor: "Arată asta la intrare.",
    addToCalendar: "ADAUGĂ ÎN CALENDAR",
    setTimes: "PROGRAMUL SETURILOR",
    refreshesIn: "SE REÎNNOIEȘTE ÎN",
    bringSomeone: "ADU PE CINEVA",
    sendAnInvite: "TRIMITE O INVITAȚIE",
    linkCopiedSend: "LINK COPIAT — TRIMITE-L",
    idMayBeRequested: "ACTUL DE IDENTITATE POATE FI CERUT",
    demos: "DEMOURI",
    sendUsOneThing: "Trimite-ne un singur lucru",
    sendIt: "TRIMITE",
    bookings: "BOOKING",
    bookAnArtist: "Rezervă un artist",
    sendTheEnquiry: "TRIMITE CEREREA",
    closedForNow: "ÎNCHIS",
  },
  es: {
    ...
    askForAPass: "Pide un pase",
    theGuestList: "LA LISTA",
    fullName: "Nombre completo",
    email: "Correo",
    phone: "Teléfono",
    howManyOfYou: "Cuántos sois",
    justMe: "Solo yo",
    peopleWord: "personas",
    anythingToKnow: "Algo que debamos saber",
    charsLeft: "RESTANTES",
    iConfirmAge: "Confirmo que tengo",
    orOver: "años o más. Pueden pedir documento en la puerta.",
    sending: "ENVIANDO…",
    requestReceived: "SOLICITUD RECIBIDA",
    thankYou: "Gracias.",
    onTheWaitingList: "EN LISTA DE ESPERA",
    inTheQueue: "EN LA COLA",
    showAtTheDoor: "Muestra esto en la puerta.",
    addToCalendar: "AÑADIR AL CALENDARIO",
    setTimes: "HORARIOS",
    refreshesIn: "SE RENUEVA EN",
    bringSomeone: "TRAE A ALGUIEN",
    sendAnInvite: "ENVIAR UNA INVITACIÓN",
    linkCopiedSend: "ENLACE COPIADO — ENVÍASELO",
    idMayBeRequested: "PUEDEN PEDIR DOCUMENTO",
    demos: "DEMOS",
    sendUsOneThing: "Mándanos una sola cosa",
    sendIt: "ENVIAR",
    bookings: "CONTRATACIÓN",
    bookAnArtist: "Contrata a un artista",
    sendTheEnquiry: "ENVIAR LA CONSULTA",
    closedForNow: "CERRADO",
  },
  de: {
    ...
    askForAPass: "Um einen Pass bitten",
    theGuestList: "DIE GÄSTELISTE",
    fullName: "Vollständiger Name",
    email: "E-Mail",
    phone: "Telefon",
    howManyOfYou: "Wie viele seid ihr",
    justMe: "Nur ich",
    peopleWord: "Personen",
    anythingToKnow: "Sollten wir etwas wissen",
    charsLeft: "ÜBRIG",
    iConfirmAge: "Ich bestätige, dass ich",
    orOver: "oder älter bin. Ausweis kann am Einlass verlangt werden.",
    sending: "WIRD GESENDET…",
    requestReceived: "ANFRAGE ERHALTEN",
    thankYou: "Danke.",
    onTheWaitingList: "AUF DER WARTELISTE",
    inTheQueue: "IN DER SCHLANGE",
    showAtTheDoor: "Zeig das am Einlass.",
    addToCalendar: "ZUM KALENDER HINZUFÜGEN",
    setTimes: "SET-ZEITEN",
    refreshesIn: "ERNEUERT SICH IN",
    bringSomeone: "BRING JEMANDEN MIT",
    sendAnInvite: "EINLADUNG SENDEN",
    linkCopiedSend: "LINK KOPIERT — SCHICK IHN WEITER",
    idMayBeRequested: "AUSWEIS KANN VERLANGT WERDEN",
    demos: "DEMOS",
    sendUsOneThing: "Schick uns eine Sache",
    sendIt: "SENDEN",
    bookings: "BOOKING",
    bookAnArtist: "Einen Artist buchen",
    sendTheEnquiry: "ANFRAGE SENDEN",
    closedForNow: "GESCHLOSSEN",
  },
  fr: {
    ...
    askForAPass: "Demander un pass",
    theGuestList: "LA GUEST LIST",
    fullName: "Nom complet",
    email: "E-mail",
    phone: "Téléphone",
    howManyOfYou: "Vous êtes combien",
    justMe: "Juste moi",
    peopleWord: "personnes",
    anythingToKnow: "Quelque chose à nous dire",
    charsLeft: "RESTANTS",
    iConfirmAge: "Je confirme avoir",
    orOver: "ans ou plus. Une pièce d'identité peut être demandée à l'entrée.",
    sending: "ENVOI…",
    requestReceived: "DEMANDE REÇUE",
    thankYou: "Merci.",
    onTheWaitingList: "SUR LISTE D'ATTENTE",
    inTheQueue: "DANS LA FILE",
    showAtTheDoor: "Montrez ceci à l'entrée.",
    addToCalendar: "AJOUTER AU CALENDRIER",
    setTimes: "HORAIRES DES SETS",
    refreshesIn: "SE RENOUVELLE DANS",
    bringSomeone: "AMENEZ QUELQU'UN",
    sendAnInvite: "ENVOYER UNE INVITATION",
    linkCopiedSend: "LIEN COPIÉ — ENVOYEZ-LE",
    idMayBeRequested: "PIÈCE D'IDENTITÉ POSSIBLE",
    demos: "DÉMOS",
    sendUsOneThing: "Envoyez-nous une seule chose",
    sendIt: "ENVOYER",
    bookings: "BOOKING",
    bookAnArtist: "Réserver un artiste",
    sendTheEnquiry: "ENVOYER LA DEMANDE",
    closedForNow: "FERMÉ",
  },
};
