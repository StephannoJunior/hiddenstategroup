...
export default function Contact() {
  ...
  return (
    <div data-page style={{ background: theme.bg, minHeight: "100vh" }}>
      ...
      <PageHead kicker="DIRECT" title="Contact" sub="GET IN TOUCH" />
        ...
        <div>
          ...
          {submitted ? (
            ...
            <form onSubmit={handleSubmit} className="space-y-5 max-w-xl">
              ...
              {error && (
                <p className="m-0 px-3 py-2.5" style={{ ...fontText, fontSize: "15px", color: theme.bad, border: `1px solid ${theme.badLine}` }}>
                  {error}
                </p>
              )}
